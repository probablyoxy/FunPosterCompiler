...
root = tk.Tk()
root.title("Just The Tip!!!")
root.geometry("750x650")  # Set the window size
...
labels = {}
button_positions = [(10, 10)]
label_positions = [(150, 10)]
for i, position in enumerate(positions):
    btn = tk.Button(frame, text=f"Select Tip", command=lambda i=i: select_image(i))
